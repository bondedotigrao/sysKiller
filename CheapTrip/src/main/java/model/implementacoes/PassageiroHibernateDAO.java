...
import model.interfaces.PassageiroDAO;
 ...
 * @author Mark IV
 */
public class PassageiroHibernateDAO implements PassageiroDAO {
    private SessionFactory sessions;
    private static PassageiroHibernateDAO instance;
    
    public PassageiroHibernateDAO getInstance(){
        if(instance == null){
